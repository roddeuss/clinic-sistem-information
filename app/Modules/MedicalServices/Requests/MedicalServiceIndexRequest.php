...
class MedicalServiceIndexRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->canAccess('view medical service management');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['nullable', 'string', Rule::in(['ordered', 'completed', 'cancelled'])],
